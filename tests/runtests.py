#!/usr/bin/python
# -*- coding: utf-8 -*-
# /root/workspace/mao/tests/runtests.py -f /root/workspace/mao/tests/testlist
...
def main(argv):
  ...
  for inputfile in args:
    ...
    mao_output = RunMao(mao_cmd, inputfile, options, plugin, target,
                        library_ext)
    printLog(mao_output)
# 例子：['/root/workspace/mao/tests/../bin/mao-x86_64-linux', '--mao=-s', '--mao=READ=create_anonymous[1]', '--mao=REDTEST=trace[1]', '/root/workspace/mao/tests/redtest.s']
