...
class MaoUnit {
 public:
  ...
  // Creates an InstructionEntry wrapping around the specified aarch64_instruction* and
  // associate it with the given function.
  InstructionEntry *CreateInstruction(aarch64_instruction *instruction,
                                      Function *function);
  ...
  std::vector<SubSection *> GetSubSectionsVector();
  // Dumpers.
  //
  ...
  void SetDefaultArch();
  void ReplaceLastEntry(MaoEntry*);
  MaoEntry*  GetLastEntry();
