...
class MaoOptions {
 public:
  ...
  void        Parse(const char *argv0, const char *arg, bool collect = true,
                    MaoUnit *unit = NULL, MaoUnit *unit_mf = NULL, MaoPassManager *pass_man = NULL);
  void        Reparse(MaoUnit *unit = NULL, MaoUnit *unit_mf = NULL, MaoPassManager *pass_man = NULL);
