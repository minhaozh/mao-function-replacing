TUNE=peak
LABEL=gcc-aarch64-withoutmao-gta-64
NUMBER=505
NAME=mcf_r
...
commandexe       = mcf_r_peak.gcc-aarch64-withoutmao-gta-64
...
compwhite        = 
configdir        = config
configfile       = gcc-aarch64
configpath       = /GPUFS/nsccgz_yfdu_16/gta/cpu2017/config/gcc-aarch64.cfg
copies           = 1
current_range    = 
datadir          = data
default_size     = ref
...
log_line_width   = 1020
log_timestamp    = 0
logfile          = /GPUFS/nsccgz_yfdu_16/gta/cpu2017/tmp/CPU2017.014/templogs/preenv.intrate.014.0
logname          = /GPUFS/nsccgz_yfdu_16/gta/cpu2017/tmp/CPU2017.014/templogs/preenv.intrate.014.0
lognum           = 014.0
mail_reports     = all
mailcompress     = 0
mailmethod       = smtp
...
notes_plat_sysinfo_010 =  running on apn508 Sat Jan  9 11:00:42 2021
...
notes_plat_sysinfo_270 =    node 0 free: 126516 MB
...
notes_plat_sysinfo_290 =    node 1 free: 130240 MB
...
notes_plat_sysinfo_310 =    node 2 free: 128428 MB
...
notes_plat_sysinfo_330 =    node 3 free: 128969 MB
...
notes_plat_sysinfo_545 =     10.20.10.100@tcp4:10.20.10.101@tcp4:/L2 lustre  1.7P  394T  1.3P  24% /GPUFS
...
review           = 0
run              = all
runcpu           = /GPUFS/nsccgz_yfdu_16/gta/cpu2017/bin/harness/runcpu --configfile gcc-aarch64 --reportable --rebuild --nopower --runmode rate --tune base:peak --size refrate intrate --nopreenv --note-preenv --logfile /GPUFS/nsccgz_yfdu_16/gta/cpu2017/tmp/CPU2017.014/templogs/preenv.intrate.014.0 --lognum 014.0 --from_runcpu 2
rundir           = run
runmode          = rate
safe_eval        = 1
save_build_files = 
