...
-E HISTSIZE 1000
-E HISTTIMEFORMAT '[%Y-%m-%d %H:%M:%S] [172.17.71.167] '
-E HOME /GPUFS/nsccgz_yfdu_16
-E HOSTNAME apn508
-E LANG zh_CN.UTF-8
-E LAST_CMD ' 1047  [2021-01-08 12:08:02] [172.17.71.167] vim mao-spec.sh '
...
-E SSH_CLIENT '172.17.71.167 58481 22'
-E SSH_CONNECTION '172.17.71.167 58481 172.16.20.220 22'
-E SSH_TTY /dev/pts/7
...
-E XDG_SESSION_ID 116900
-r
-N C
-C /GPUFS/nsccgz_yfdu_16/gta/cpu2017/benchspec/CPU/505.mcf_r/run/run_base_train_gcc-aarch64-mao-gta-64.0000
-o inp.out -e inp.err ../run_base_train_gcc-aarch64-mao-gta-64.0000/mcf_r_base.gcc-aarch64-mao-gta-64 inp.in  > inp.out 2>> inp.err
