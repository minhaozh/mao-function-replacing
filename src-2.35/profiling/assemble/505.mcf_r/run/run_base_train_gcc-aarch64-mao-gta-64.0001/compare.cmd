...
-E HISTSIZE 1000
-E HISTTIMEFORMAT '[%Y-%m-%d %H:%M:%S] [172.17.68.85] '
-E HOME /GPUFS/nsccgz_yfdu_16
-E HOSTNAME apn507
-E LANG zh_CN.UTF-8
-E LAST_CMD ' 1008  [2021-01-09 10:07:57] [172.17.68.85] vim mao-spec.sh '
...
-E SLURM_TASK_PID 110467
-E SLURM_TOPOLOGY_ADDR apn507
...
-E SSH_CLIENT '172.17.68.85 57908 22'
-E SSH_CONNECTION '172.17.68.85 57908 172.16.20.220 22'
-E SSH_TTY /dev/pts/1
...
-E XDG_SESSION_ID 118527
-r
-N C
-C /GPUFS/nsccgz_yfdu_16/gta/cpu2017/benchspec/CPU/505.mcf_r/run/run_base_train_gcc-aarch64-mao-gta-64.0001
-k -o inp.out.cmp /GPUFS/nsccgz_yfdu_16/gta/cpu2017/bin/specperl /GPUFS/nsccgz_yfdu_16/gta/cpu2017/bin/harness/specdiff -m -l 10 /GPUFS/nsccgz_yfdu_16/gta/cpu2017/benchspec/CPU/505.mcf_r/data/train/output/inp.out inp.out > inp.out.cmp
-k -o mcf.out.cmp /GPUFS/nsccgz_yfdu_16/gta/cpu2017/bin/specperl /GPUFS/nsccgz_yfdu_16/gta/cpu2017/bin/harness/specdiff -m -l 10 /GPUFS/nsccgz_yfdu_16/gta/cpu2017/benchspec/CPU/505.mcf_r/data/train/output/mcf.out mcf.out > mcf.out.cmp
