...
dot_cfi (int arg)
{
  ...
  switch (arg)
    ...
    case DW_CFA_val_offset:
      ...
      /********************new added code*********************/
      link_cfi_val_offset_directive(GetStringPiece(before_pointer,after_pointer),offset);
      /********************new added code*********************/
      break;
...
dot_cfi_personality_id (int ignored ATTRIBUTE_UNUSED)
{
  ...
  /********************new added code*********************/
  link_cfi_personality_id_directive(fde->personality_id);
  /********************new added code*********************/
...
dot_cfi_fde_data (int ignored ATTRIBUTE_UNUSED)
{
  ...
  if ((cfi_sections & CFI_EMIT_target) != 0
      ...
      if (!is_it_end_of_statement ())
	{
	  ...
	  do
	    {
	      e = XNEW (struct cfi_escape_data);
	      do_parse_cons_expression (&e->exp, 1);         //QUES: Which func exactly it uses remains to be seen
	      *tail = e;
	      tail = &e->next;
        /********************new added code*********************/
	      expr_array[index++] = &e->exp;
        /********************new added code*********************/
        num_ops++;
	    }
	  while (*input_line_pointer++ == ',');
  ...
  /********************new added code*********************/
  link_cfi_fde_data_directive(index,expr_array);
  /********************new added code*********************/
...
dot_cfi_inline_lsda (int ignored ATTRIBUTE_UNUSED)
{
  ...
  /********************new added code*********************/
  link_cfi_inline_lsda_directive(align);
  /********************new added code*********************/
