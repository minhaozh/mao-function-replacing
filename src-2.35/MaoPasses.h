...
// MergeFunctionPass
//
class MergeFunctionPass : public MaoPass {
public:
    MergeFunctionPass(MaoOptionMap *options,
                      MaoUnit *mao_unit, MaoUnit *mao_unit_mf);

    bool Go();

    void replaceFunction(MaoEntry *startOld, MaoEntry *endOld,
...
class MaoPassManager {
 public:
  typedef MaoPass *(*PassCreator)(MaoOptionMap *options, MaoUnit *unit,MaoUnit *unit_mf);

  explicit MaoPassManager(MaoUnit *unit, MaoUnit *unit_mf) : unit_(unit),unit_mf_(unit_mf) { }
  ~MaoPassManager() {
  ...
  template <class Pass>
  static MaoPass *GenericPassCreator(MaoOptionMap *options, MaoUnit *unit, MaoUnit *unit_mf = NULL) {
    return new Pass(options, unit);
  }

  static MaoPass *MergeFunctionPassCreator(MaoOptionMap *options, MaoUnit *unit, MaoUnit *unit_mf) {
      return new MergeFunctionPass(options, unit, unit_mf);
  }
